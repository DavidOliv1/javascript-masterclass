...
// As declarações de import sofrem processo de 'hoisting', o que significa que são içadas para o topo do arquivo, mesmo que declaradas depois da sua utilização.
