...
// Em caso de fracasso, a função reject deve ser executada, sendo tratada por meio de catch. Perceba que no código abaixo, só estamos tratando o erro da função mais interna do encadeamento.
