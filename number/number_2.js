...
// Por padrão, ao imprimirmos um number, é feito o toString e convertido para a base 10.

// Também podemos usar a função construtora para criar um novo Number:

console.log(new Number(10));
console.log(new Number(9.9));
console.log(new Number(0xff));
console.log(new Number(0b11));
console.log(new Number(010));
console.log(new Number(0x1a));
console.log(new Number(0o7));
console.log(new Number(0o12));
